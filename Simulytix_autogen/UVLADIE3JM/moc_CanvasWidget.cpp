...
QT_MOC_LITERAL(1, 13, 17), // "componentSelected"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 4) // "kind"

    },
    "CanvasWidget\0componentSelected\0\0kind"
};
...
void CanvasWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->componentSelected((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CanvasWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CanvasWidget::componentSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CanvasWidget::componentSelected(int _t1)
{
